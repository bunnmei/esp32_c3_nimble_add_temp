...
static const ble_uuid16_t auto_temp_svc_uuid = BLE_UUID16_INIT(0x1815);
static uint8_t temp_chr_val[2] = {0};

static uint16_t temp_chr_val_handle;
static const ble_uuid128_t temp_chr_uuid = BLE_UUID128_INIT(0x71, 0x19, 0x8d, 0x7e, 0xb9, 0x39, 0x18, 0xf6, 0xe4, 0x1e, 0xf4, 0x9d, 0x8f, 0x59, 0xa7, 0x91);
...
void gatt_svr_subscribe_cb(struct ble_gap_event *event) {
    ...
    } else if (event->subscribe.attr_handle == temp_chr_val_handle) {
